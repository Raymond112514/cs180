...
<div style="display: flex; justify-content: space-between;">
  ...
  <div style="text-align: center; width: 30%;">
    <p style="font-size: small; margin: 5px 0;"> Blurred gradient in magnitude </p>
    <img src="{{ site.baseurl }}/assets/proj2_images/cameraman_blurred_magnitude.jpg" alt="Image 3" style="width: 100%; height: auto;">
  </div>
</div>
<p style="text-align: center; margin-top: 15px;"><strong>Figure 4:</strong> Blurred cameraman image.</p>
