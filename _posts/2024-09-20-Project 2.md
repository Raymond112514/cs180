...
Another way to perform the operation is to combine the derivative filter with the Gaussian filter, resulting in the derivative of Gaussian filter. This approach yields the same results.
...
<p style="text-align: center; margin-top: 15px;"><strong>Figure 6:</strong> Separate red, green, and blue channels from the glass plate negatives.</p>
