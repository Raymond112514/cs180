...
<div class="slideshow-container second-slider">

  <div class="mySlides fade">
    <div class="image-container">
      <img src="{{ site.baseurl }}/assets/images/new_image1.png" class="side-by-side-image">
      <img src="{{ site.baseurl }}/assets/images/new_image2.png" class="side-by-side-image">
    </div>
  </div>

  <div class="mySlides fade">
    <div class="image-container">
      <img src="{{ site.baseurl }}/assets/images/new_image3.png" class="side-by-side-image">
      <img src="{{ site.baseurl }}/assets/images/new_image4.png" class="side-by-side-image">
    </div>
  </div>

  <a class="prev" onclick="plusSlides(-1, 'second-slider')">❮</a>
  <a class="next" onclick="plusSlides(1, 'second-slider')">❯</a>

</div>
<br>

<div style="text-align:center">
  <span class="dot" onclick="currentSlide(1, 'second-slider')"></span> 
  <span class="dot" onclick="currentSlide(2, 'second-slider')"></span> 
</div>
